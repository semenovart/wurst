...
Интерактивный сайт-ритуал (рабочее имя репозитория — sosiska-digger): закопай
сосиску перед свадьбой — и на свадьбе будет хорошая погода. Гость проходит тактильный 3D-ритуал (выбрать место → выкопать
